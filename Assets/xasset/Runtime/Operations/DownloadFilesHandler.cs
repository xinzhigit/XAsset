...
namespace xasset
{
    public interface IDownloadFilesHandler
    {
        ...
        void Cancel(DownloadFiles downloadFiles);
    }
    ...
    public class DownloadFilesHandler : IDownloadFilesHandler
    {
        ...
        public void Cancel(DownloadFiles downloadFiles)
        {
            foreach (var download in _progressing)
            {
                download.Cancel();
                Debug.LogWarning($"Cancel Download {download.info.url}.");
            }
            _progressing.Clear();
        }
    }
    ...
    public class WebGLDownloadFilesHandler : IDownloadFilesHandler
    {
        ...
        public void Cancel(DownloadFiles downloadFiles)
        {
            foreach (var bundle in _progressing)
            {
                bundle.Release();
                Debug.LogWarning($"Cancel Download {bundle.pathOrURL}.");
            }
            _progressing.Clear();
        }
    }
